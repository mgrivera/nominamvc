<%@ Page Title="Log In" Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ConfigureAuthenticationDemo1.Account.Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Nómina - indique un nombre de usuario y password</title>
    <style type="text/css">
        .MarginTop
        {
            margin-top: 15px; 
...
<body>
    ...
    <div style="padding-top:45px; padding-left:45px; " >
         ...
         <span id="ErrMessage_Span" 
               runat="server" 
               class="errmessage errmessage_background notsosmallfont"
               style="display: block; margin-bottom: 15px; width: 50%; ">
        </span>
        ...
        <asp:Login ID="Login1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE" 
            ...
            TitleText="Nómina  -  Iniciar sesión" 
            CreateUserText="<br />Registre un nuevo usuario aquí" 
