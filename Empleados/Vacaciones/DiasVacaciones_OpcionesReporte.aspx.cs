...
{
    public partial class DiasVacaciones_OpcionesReporte : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.Page.Title = "Nómina - Empleados - Control de días de vacaciones - Consulta";
        ...
        protected void ObtenerReporte_Button_Click(object sender, EventArgs e)
        {
            ...
            if (this.NormalFormat_RadioButton.Checked)
                Response.Redirect("~/ReportViewer.aspx?rpt=ControlDiasVacaciones&opc=normal");
            else
                Response.Redirect("~/ReportViewer.aspx?rpt=ControlDiasVacaciones&opc=pdf");
        }
    }
}