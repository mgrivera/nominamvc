<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Simple.Master" AutoEventWireup="true" CodeBehind="OpcionesReporte.aspx.cs" Inherits="NominaASP.Consulta.Nomina.OpcionesReporte" ValidateRequest="false" %>
            ...
            <div>
                ...
                <fieldset style="margin: 0px 25px 25px 25px; padding: 15px; text-align: center; " class="generalfont">
                    ...
                    <div style="text-align: left; ">
                        Sub título reporte: <asp:TextBox ID="SubTitulo_TextBox" runat="server" AutoPostBack="True" OnTextChanged="SetLinkAddress" />
                    </div>
