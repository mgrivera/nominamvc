...
namespace NominaASP.Code
{
    public class KeepPageState
    {
        ...
        public void ReadStateFromFile(Page AspNetPage, ControlCollection MyControlCollection)
        {
            ...
            foreach (string Split in splitout)
            {
                ...
                if ((nPosSignoIgual > 0))
                {
                    ...
                    System.Web.UI.Control MyWebServerControl = FindControlRecursive(MyControlCollection, sNombreControl);
                    ...
                    switch (MyWebServerControl.GetType().Name.ToString())
                    {
                        ...
                        case "CheckBox":
                            System.Web.UI.WebControls.CheckBox MyWebControlCheckbox = (System.Web.UI.WebControls.CheckBox)MyWebServerControl;
                            if ((sContenido == "1"))
                            {
                        ...
                        case "RadioButton":
                            System.Web.UI.WebControls.RadioButton MyWebControlRadioButton = (System.Web.UI.WebControls.RadioButton)MyWebServerControl;
                            if ((sContenido == "1"))
                            {
                        ...
                        case "ListBox":
                            {
                                System.Web.UI.WebControls.ListBox MyWebControlListBox = (System.Web.UI.WebControls.ListBox)MyWebServerControl;
                        ...
                        case "DropDownList":
                            System.Web.UI.WebControls.DropDownList MyWebControlDropDownList = (System.Web.UI.WebControls.DropDownList)MyWebServerControl;
        ...
        private Control FindControlRecursive(ControlCollection Root, string id)
        {
            foreach (Control ctl in Root)
            {
                if (ctl.HasControls()) 
                {
                    Control control = FindControlRecursive(ctl.Controls, id);
                    if (control != null)
                        return control; 
                }
                else 
